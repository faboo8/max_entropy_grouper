...
df = pd.read_excel(sheet_name=1, skiprows=range(8), io = 'Digital Day 2018 - Teilnehmer_Berlin.xlsx',
                   header=None, names= ['role', 'name', 'branch', 'gender'], usecols=[0,1,2,3])
...
def propose_switch(dfs, df):
    ...
    if entr_n < entr_o or random.choice(range(999))==0.1:
